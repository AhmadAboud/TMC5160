...
#ifndef INC_HX711_ADC_HPP_
#define INC_HX711_ADC_HPP_
...
class HX711_ADC
{
	...
	public:
		HX711_ADC(uint16_t dout,GPIO_TypeDef* portDout, uint16_t sck, GPIO_TypeDef* portSck); 		//constructor
