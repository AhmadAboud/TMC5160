...
# BASED ON c:\Users\ahmad.alaboud\STM32CubeIDE\workspace_1.12.1\TMC5160_H725
...
target_link_options(
    ...
    "$<$<NOT:$<CONFIG:Debug>>:-mfloat-abi=hard>"
    -T
    "$<$<CONFIG:Debug>:${PROJECT_SOURCE_DIR}/STM32H725IGKX_FLASH.ld>"
    "$<$<NOT:$<CONFIG:Debug>>:${PROJECT_SOURCE_DIR}/STM32H725IGKX_FLASH.ld>"
)
